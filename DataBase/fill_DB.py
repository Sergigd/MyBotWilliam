...
while data.get_last_id() < 10000:
    ...
    url_questions = "" + API.get_url_questions_dates((year, month, day, 0, 0, 0, 0, 0, 0), (n_year, n_month, n_day, 0, 0, 0, 0, 0, 0))
    # print(url_questions)
